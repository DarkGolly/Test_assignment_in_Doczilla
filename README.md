...
### WaterSortingProblem
Консольное приложение, которое решает головоломку сортировки воды для заданного начального состояния, выводит начальное и конечное состояния трубки и последовательность ходов.
### FileSharingService
